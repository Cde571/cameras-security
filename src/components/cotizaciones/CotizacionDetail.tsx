...
import { ArrowLeft, FileText, Pencil, GitBranch, Trash2 } from "lucide-react";
import { calcTotales, deleteCotizacion, getCotizacion, type Cotizacion } from "../../lib/services/cotizacionLocalService";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <section className="lg:col-span-2 rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600">{c.cliente?.documento || ""} {c.cliente?.ciudad ? `• ${c.cliente.ciudad}` : ""}</p>
          </div>

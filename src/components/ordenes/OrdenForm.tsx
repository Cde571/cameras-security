...
import { createOrden, getOrden, listChecklistTemplates, getChecklistTemplate, updateOrden, type ChecklistItem, type OrdenStatus, type Tecnico } from "../../lib/services/ordenLocalService";
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-3">
            <div className="flex items-center justify-between gap-2">
              <h3 className="font-semibold text-gray-900 flex items-center gap-2"><ClipboardList className="h-4 w-4" /> Checklist</h3>
        ...
        <aside className="space-y-5">
          ...
          {isEdit && ordenId ? (
            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm space-y-2">
              ...
              <a href={`/ordenes/${ordenId}`} className="block rounded-lg border border-gray-300 bg-white px-3 py-2 hover:bg-gray-50 text-sm">
                Ver detalle
              </a>
              <a href={`/ordenes/${ordenId}/evidencias`} className="block rounded-lg border border-gray-300 bg-white px-3 py-2 hover:bg-gray-50 text-sm">
                Evidencias
              </a>
            </div>
          ) : null}
